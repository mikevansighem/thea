...
class Communicator(BaseItem):
    ...
    def _additional_init(self, **kwargs) -> dict:
        ...
        self.comm_handler = Process(target=self.comm_handler, args=(self.message_queue, **self.properties), daemon=True)
    ...
    def disconnect(self):
        ...
        if self.status is True:
            ...
            print(f'Disconnected {self} and deleted {no_unsend_messages} unsent messages.')
